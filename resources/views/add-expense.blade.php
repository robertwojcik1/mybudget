...
{{--                        Payment method--}}
                        <div class="mb-4">
                            ...
                            <select id="paymentMethod" class="block rounded mt-1 w-full dark:bg-gray-900 text-gray-300 focus:border-indigo-700">
                                <option value="1">Opcja 4</option>
                                <option value="2">Opcja 5</option>
                                <option value="3">Opcja 6</option>
                            </select>
                        </div>
                        {{--                Amount--}}
                        <div class="mb-4">
