            ...
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                    <form method="POST" action="{{ route('storeExpense') }}">
                        ...
                        {{--               Payment method--}}
                        <div class="mb-4">
                            <label for="paymentMethod" class="block mb-2 text-sm font-medium text-gray-300">Metoda płatności</label>
                            <select id="paymentMethod" name="paymentMethod" required class="block rounded mt-1 w-full dark:bg-gray-900 text-gray-300 focus:border-indigo-700">
                        ...
                        {{--                Amount--}}
                        <div class="mb-4">
                            <label for="amount" class="block text-sm mb-2 font-medium text-gray-300">Kwota</label>
                            <input type="number" required class="block rounded mt-1 w-full dark:bg-gray-900 text-gray-300 focus:border-indigo-700" id="amount" name="amount" step="1" min="0"max="1000000" placeholder="0.00" />
                        </div>
                        <div class="mb-4">
